...
import { createPost, AssetInput } from "@/lib/weibo";
import { fileApi } from "@/lib/file-api";
import { useRouter } from "next/navigation";
import FileThumbnail from "@/components/FileThumbnail";
import { Typography, Space, Button, Spin, Alert, Form, Input, Select, Grid, Divider, Message, Tag, Card } from "@arco-design/web-react";
            ...
            <Card bordered>
              <Space direction="vertical" style={{ width: '100%' }}>
                <Form.Item label="选择图片上传">
                  ...
                  <input id="newImageInput" type="file" accept="image/*" onChange={onSelectFile} style={{ display: 'none' }} />
                  <Button type="primary" onClick={() => (document.getElementById('newImageInput') as HTMLInputElement | null)?.click()}>选择文件</Button>
                </Form.Item>
                ...
                {uploadedPreviewUrl && (
                  <div style={{ maxWidth: 320 }}>
                    ...
                    <img src={uploadedPreviewUrl} alt="预览" style={{ maxWidth: '100%', borderRadius: 8 }} />
                  </div>
                )}
              </Space>
            </Card>
