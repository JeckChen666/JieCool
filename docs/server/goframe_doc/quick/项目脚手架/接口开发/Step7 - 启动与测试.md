...
![goframe api swagger](scaffold-swagger-ui-api-list.png)

:::tip
自动化的接口文档生成也是`GoFrame`框架提供的非常强大的特性之一，我们这里不做详细的介绍，感兴趣的朋友可以参考章节：[接口文档](../../../goframe_doc/docs/WEB服务开发/接口文档/接口文档.md)
:::
