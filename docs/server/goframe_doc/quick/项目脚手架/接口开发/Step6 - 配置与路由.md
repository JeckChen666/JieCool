...
更多关于数据库驱动的支持以及详细介绍，请参考章节 [数据库ORM](../../../goframe_doc/docs/核心组件/数据库ORM/数据库ORM.md)。
...
每一项组件配置的注释上提供了官网文档的配置参考链接。我们这里需要修改数据库配置中的链接信息，为我们真实可用的链接信息。关于数据库的配置详细介绍，感兴趣请参考章节：[ORM使用配置-配置文件](../../../goframe_doc/docs/核心组件/数据库ORM/ORM使用配置/ORM使用配置-配置文件.md)
...
![goframe路由注册](scaffold-route-registration.png)
