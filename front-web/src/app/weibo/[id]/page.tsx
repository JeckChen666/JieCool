...
import {deletePost, getDetail} from "@/lib/weibo";
import {
    Alert,
    Button,
    Card,
                    ...
                    <Card bordered hoverable>
                        <Space direction="vertical" size={12} style={{width: '100%'}}>
                            <Space size={8}>
                                ...
                                <Tag
                                    color={data.visibility === 'private' ? 'orangered' : 'green'}>{data.visibility}</Tag>
                            </Space>
                            <Typography.Paragraph style={{whiteSpace: 'pre-wrap'}}>{data.content}</Typography.Paragraph>
                            <Descriptions border column={1} title="附加信息" data={[
                                ...(data.city ? [{
                                    label: '城市',
                                    value: data.city
                                }] : []),
