...
![alt text](goland-new-project-location.png)
...
![alt text](goland-hello-world-edit.png)

#### Step4. 执行运行

菜单栏 `Run` - `Run` - `go build hello.go`。

![alt text](goland-run-menu.png)

![alt text](goland-run-output.png)

![alt text](goland-first-program-success.png)
